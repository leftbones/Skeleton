...
public class Container {
	...
	public Container(Vector2 position, Vector2 size, float? margin=null, float? padding=null, float? spacing=null, Style? style=null) {
		Position = position;
		Size = size;
		Margin = margin ?? 25.0f;
	...
	public bool FireEvent(Event e) {
		if (e is MouseWheelEvent) {
			Console.WriteLine($"Mouse was moved! {((MouseWheelEvent)e).Amount}");
			return true;
		}
